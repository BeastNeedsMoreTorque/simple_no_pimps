      ...
      <table className='w-full text-base'>
        <thead className='border-b'>
          <tr className='text-left'>
            ...
            <th className='hidden p-1 pb-2 text-center md:table-cell'>FORM</th>
          </tr>
        </thead>
        <tbody>
          {tableStandings.map((match, index) => (
            <tr
              ...
              <td className='border-b bg-white p-1 text-left'>{match.team}</td>
